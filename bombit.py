...
ascii = pyfiglet.figlet_format("H4ckr0pZ")
...
def pretty_print(logo,cc, target, success, failed):
    print(logo)
    ...
    mesgdcrt.SuccessMessage("Bombit was created by H4ckr0pZ")


def workernode(logo,mode, cc, target, count, delay, max_threads):
        ...
        with ThreadPoolExecutor(max_workers=max_threads) as executor:
            ...
            for job in as_completed(jobs):
                ...
                if result:
                    ...
                    failed += 1
                clr()
                pretty_print(logo,cc, target, success, failed)
    print("\n")
...
def selectnode(mode="sms"):
    ...
    try:
        ...
        max_limit = {"sms": 100000000000000000500, "call": 1000000000000000000015, "mail": 2000000000000000000}
        cc, target = "", ""
        if mode in ["sms", "call"]:
        ...
        workernode(logo,mode, cc, target, count, delay, max_threads)
...
__CONTRIBUTORS__ = ['SpeedX', 't0xic0der', 'H4ckr0pZ' , 'scpketer', 'Stefan']
